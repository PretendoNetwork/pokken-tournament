...
func registerCommonAuthenticationServerProtocols() {
	...
	secureStationURL.SetAddress(os.Getenv("PN_POKKENTOURNAMENT_SECURE_SERVER_HOST"))
	port, _ := strconv.ParseUint(os.Getenv("PN_POKKENTOURNAMENT_SECURE_SERVER_PORT"), 10, 32)
